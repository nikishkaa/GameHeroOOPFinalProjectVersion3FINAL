...
import by.itstep.goutor.finaloopproject.model.entity.container.GroupByList;
...
public class GameManagerLIST {
    ...
    public static boolean calculateVinHeroBoosWithStartStaff(GroupByList hero, GroupByList boss) {
        if (hero == null || boss == null || Group.DEFAULT_SIZE == 0
                || hero.getEntity().isEmpty() || boss.getEntity().isEmpty()) {
    ...
    private static Artifact findMinStatArtifact(List<Artifact> artifacts, GroupByList hero, GroupByList boss) {
    ...
    public static Artifact getMinStatArtifact(List<Artifact> artifacts, GroupByList hero, GroupByList boss) {
        if (hero == null || boss == null || Group.DEFAULT_SIZE == 0
    ...
    private static int calculateVinStat(GroupByList group) {
        int stat = 0;
